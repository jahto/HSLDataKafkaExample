 ...
 * @author jah
 */
public class FSTInstantWithoutNanosSerializer extends FSTBasicObjectSerializer {

    @Override
    public void writeObject(FSTObjectOutput out, Object toWrite, FSTClazzInfo clzInfo, FSTClazzInfo.FSTFieldInfo referencedBy, int streamPosition) throws IOException {
        SerializerImplementations.serializeInstantWithoutNanos(toWrite, out);
    }
    ...
    public Object instantiate(Class objectClass, FSTObjectInput in, FSTClazzInfo serializationInfo, FSTClazzInfo.FSTFieldInfo referencee, int streamPosition) throws Exception {
        return SerializerImplementations.deserializeInstantWithoutNanos(in);
    }
}
